...
public class Employment
{
    ...
    [ProtoMember(3)] public string CompanyName { get; set; } = string.Empty;

    [ProtoMember(4)] public string JobTitle { get; set; } = string.Empty;

    [ProtoMember(5)] public string? JobDescription { get; set; }
